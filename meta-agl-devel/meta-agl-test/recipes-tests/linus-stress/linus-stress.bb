...
LIC_FILES_CHKSUM = "file://linus_stress/LICENSE;md5=b234ee4d69f5fce4486a80fdaf4a4263"
...
S = "${UNPACKDIR}/${BP}/linus_stress"

do_install() {
    install -d ${D}/usr/AGL/agl-test/tests/linus_stress/resource/
    install -m 0755 ${B}/linus_stress ${D}/usr/AGL/agl-test/tests/linus_stress/resource/
}
